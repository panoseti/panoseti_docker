...
sudo docker run -d --name panoseti-grafana --hostname panoseti-grafana --net=panoseti-bridge  --user $ID -v /home/wei/database/grafana:/var/lib/grafana grafana/grafana
