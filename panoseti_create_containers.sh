...
sudo docker run -itd --name panoseti_control --net=panoseti-bridge --hostname headnode --device=/dev/ttyUSB5 -v /home/wei/headnode_data:/home/data panoseti_control:latest
